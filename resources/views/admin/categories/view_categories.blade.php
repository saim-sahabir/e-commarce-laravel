              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                   ...
                   <!--  <a  id="delCat" href="{{ url('/admin/delete-category/'.$category->id) }}" class="delete btn btn-danger btn-mini">Delete</a> -->

                    <a rel="{{ $category->id }}" rell="delete-category"     href="javascript:" class=" btn btn-danger btn-mini deleteRecordcategory">Delete</a>
