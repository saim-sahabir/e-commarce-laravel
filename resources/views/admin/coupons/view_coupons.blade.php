              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a  <?php /*onclick="return delCoupon()"  href="{{ url('/admin/delete-coupon/'.$coupon->id) }}"*/ ?>   rel="{{ $coupon->id }}" rell="delete-coupon" href="javascript:" class=" btn btn-danger btn-mini   deleteRecordCoupon" title="delete coupon">Delete</a>
