              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a href="{{ url('/admin/add-attribute/'.$product->id) }}"  class="btn btn-success btn-mini" title="add attributes">Add</a>
                    <a href="{{ url('/admin/add-images/'.$product->id) }}"  class="btn btn-info btn-mini" title="add alternate images">Add</a>

                    <a rel="{{ $product->id }}" rell="delete-product"     href="javascript:" class=" btn btn-danger btn-mini deleteRecord" title="delete product">Delete</a>
