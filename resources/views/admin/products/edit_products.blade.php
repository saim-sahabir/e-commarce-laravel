            ...
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/edit-product/'.$productDetails->id) }}" name="edit_product" id="edit_product" novalidate="novalidate"> {{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <img src="{{asset('/backend/images/products/small/'.$productDetails->image)}}"  style="width:60px;height: 60px;"><a href="{{url('/admin/delete-products-image/'.$productDetails->id)}}">| Delete</a>
                  @endif
                </div>
              </div>
                <div class="control-group">
