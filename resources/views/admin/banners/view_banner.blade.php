                ...
                <tr class="gradeX">
                  ...
                  <td>
                    @if(!empty($banner->image))
                      <img src="{{ asset('/frontend/images/banner/'.$banner->image) }}" style="width:60px;">
                    @endif
                  </td>
                  <td class="center">                  
                    <a href="{{ url('/admin/edit-banner/'.$banner->id) }}" class="btn btn-primary btn-mini" title="edit banner ">Edit</a>            
                    <a rel="{{ $banner->id }}" rell="delete-banner" href="javascript:" class=" btn btn-danger btn-mini deleteRecordbanner" title="delete banner">Delete</a>
                  </td>
                </tr>
